class CorrectionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @correction.save
        format.html { redirect_to question_path(@correction.answer.question), notice: 'Correction was successfully created.' }
  ...
  private
    ...
    def correction_params
      params.require(:correction).permit(:text, :user_id, :answer_id)
    end
end
